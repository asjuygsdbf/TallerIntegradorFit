...
def draw_rounded_rect(img, rect_start, rect_end, corner_width, box_color):
    ...
    # dibujar elipses rellenas en las esquinas
...
def find_angle(p1, p2, ref_pt = np.array([0,0])):
    # calcula el ángulo entre dos vectores respecto a un punto de referencia
    p1_ref = p1 - ref_pt
    p2_ref = p2 - ref_pt
...
def get_landmark_array(pose_landmark, key, frame_width, frame_height):
    # convierte coordenadas normalizadas a píxeles reales
...
def get_landmark_features(kp_results, dict_features, feature, frame_width, frame_height):
    ...
    if feature == 'nose':
        ...
        # extrae coordenadas de puntos clave del cuerpo
        ...
        raise ValueError("La característica debe ser 'nose', 'left' o 'right'")
